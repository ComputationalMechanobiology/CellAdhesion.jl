...
#     int_1 = interface(5, 1.0, 15.0, model1)
#     int_2 = interface(5, 1.0, 15.0, model2)
#     int_3 = interface(5, 1.0, 15.0, model3)
...
#     int_1 = interface([2, 3], [1.0, 0.1], 15.0,  model1)
#     int_2 = interface([2, 3], [1.0, 0.1], 15.0, model2)
#     int_3 = interface([2, 3], [1.0, 0.1], 15.0,  model3)
...
#   n = 5
#   l = 1
#   v1 = Interface(Bond.([true,true,true,true,true], zeros(n), zeros(n), zeros(n)n)), false, 10.0, n, l)
#   update_state(v1)
#   force(v1, model1)
#   v2 = Interface(Bond.([false,false,false,false,false], zeros(n), zeros(n), zeros(n) n)), false, 10.0, n, l)
#   update_state(v2)
#   force(v2, model1)
...
#   n = 5
#   l = 1
#   v1 = Interface(Bond.([true,true,true, true, true], zeros(n), zeros(n), zeros(n), n)), false, 0.0, n, l)
#   v2 = Interface(Bond.([true,true,true, true, true], zeros(n), zeros(n), zeros(n), n)), false, 0.0, n, l)
...
#   v3 = Interface(Bond.([false,false,false, false, false], zeros(n), zeros(n), zeros(n), n)), false, 0.0, n, l)
#   v4 = Interface(Bond.([false,false,false, false, false], zeros(n), zeros(n), zeros(n), n)), false, 0.0, n, l)
