...
function interface(n::Union{Int, Vector{Int}}, l::Union{Float64, Vector{Float64}}, model::Base.RefValue{Model}, F::Union{Int64,Float64}, f_model::Union{Symbol, Vector{Symbol}})
